...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        register = (Button) findViewById(R.id.createNewAccount);
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent = new Intent(MainActivity.this,Uwiragiye.class);
    ...
    public void submit(){
        ...
        if (c != null){
            if (c.getCount() > 0){
                ...
                Intent intent = new Intent(MainActivity.this,Pelagie.class);
                startActivity(intent);
            }
